...
const DashboardLayout = () => {
  ...
  useEffect(() => {
    const hasReloaded = localStorage.getItem("dashboard-reloaded");

    if (!hasReloaded) {
      localStorage.setItem("dashboard-reloaded", "true");
  ...
  return (
    <div className="drawer lg:drawer-open">
      ...
      <div className="drawer-side border-r border-gray-100 z-20">
        ...
        <aside className="menu p-4 w-64 min-h-full bg-gradient-to-bl from-indigo-50 via-indigo-50 to-indigo-50   space-y-1">
          <div className="px-3">
            <Logo></Logo>
          </div>
