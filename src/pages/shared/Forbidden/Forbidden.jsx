...
const Forbidden = () => {
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center px-4 text-gray-800">
      <MdBlock className="text-green-500 text-7xl mb-6" />
      ...
      <Link
        to="/"
        className="bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-xl text-sm md:text-base transition duration-200 shadow-md"
      >
        Go Back Home
      </Link>
    </div>
