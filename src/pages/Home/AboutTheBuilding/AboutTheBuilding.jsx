    ...
    <section className="text-gray-900">
      <div className="mx-auto bg-white bg-opacity-70 backdrop-blur-sm border border-gray-200 rounded-2xl p-8 shadow-lg">
        ...
        <p className="text-lg leading-relaxed text-gray-600">
          Welcome to <span className="text-green-500 font-semibold">BuildMate</span> — your modern housing solution built with precision, design, and lifestyle in mind. This building blends cutting-edge architecture with premium amenities for elevated urban living.
        </p>
