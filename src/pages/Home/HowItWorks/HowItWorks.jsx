  ...
  return (
    <section className="bg-white border border-gray-200 rounded-3xl p-8 text-gray-900 shadow-lg">
      ...
      <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-3">
        {/* Step 1 */}
        <div className="bg-indigo-50/50 backdrop-blur-sm border border-indigo-200 rounded-xl p-6 flex flex-col items-center text-center transition-shadow duration-300 hover:shadow-lg">
